...
<div class="admin_stage_container col-md-12">
			...
			<div class="admin_stage">
				...
				<div class="admin_stage_head">
					...
					<ul class="nav nav-tabs">
						<li class="active">
							<a href="#band-inbox" data-toggle="tab">Inbox</a>
						</li>
						<li>
							<a href="#band-sent" data-toggle="tab">Sent</a>
						</li>
						<li>
							<a href="#band-archived" data-toggle="tab">Archived</a>
						</li>
						<li>
							<a href="#band-trashed" data-toggle="tab">Trashed</a>
						</li>
				...
				<div class="admin_stage_content">
					<div class="tab-content">
						<!-- ////////////////// inbox tab content ////////////////// -->
						<div class="tab-pane active" id="band-inbox">
						...
						<!-- ////////////////// sent tab content ////////////////// -->
						<div class="tab-pane" id="band-sent">
							<div class="messages_inbox">
								<div class="messages_inbox_controls">
									<p class="select_section">Select: <a href="#">all</a> | <a href="#">none</a> </p>
									<button type="button" class="btn btn-default btn-sm">
						...
						<div class="tab-pane" id="band-archived">
							<div class="messages_inbox">
								<div class="messages_inbox_controls">
									<p class="select_section">Select: <a href="#">all</a> | <a href="#">none</a> </p>
									<button type="button" class="btn btn-default btn-sm">
						...
						<div class="tab-pane" id="band-trashed">
							<div class="messages_inbox">
								<div class="messages_inbox_controls">
									<p class="select_section">Select: <a href="#">all</a> | <a href="#">none</a> </p>
									<button type="button" class="btn btn-default btn-sm">
