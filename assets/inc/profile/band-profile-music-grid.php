				...
				<div class="row profile_grid_content">
					<div class="col-md-3">
						...
						<div class="band_info_container">
							...
							<a href="#" class="grid_icon_link"><i class="icon-star favourite_icon"></i></a>
							<a href="#" class="grid_icon_link"><i class="icon-share share_icon"></i></a>
						</div>
					</div>
