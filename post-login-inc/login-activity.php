	...
	<div class="action_activity_inner">
		<ul class="list-unstyled">
			<li class="action_activity row-fluid">
				<div class="col-md-3 action_activity_left">
					<? include ('inc/activity_controls.php');?>
				</div>
				<div class="col-md-9 action_activity_right">
					...
					<div class="action_activity_content">
						...
						<div class="action_activity_mixtape_wrap">
							...
							<div class="action_activity_mixtape_content">
								<h3>Mixtape Title</h3>
								<div class="action_activity_mixtape_meta">
									14 Tracks&nbsp;&nbsp;&middot;&nbsp;&nbsp;Hip Hop&nbsp;&nbsp;&middot;&nbsp;
									<ul class="global_tags list-inline pull-right">
										<li><a>dance</a></li>
										<li><a>party</a></li>
										<li><a>twerk it gurl</a></li>
									</ul>
								</div>
							</div>
						</div>
